...
%-> 英文封面信息
%-
\TITLE{Progressive Adaptive Sampling for Reinforcement Learning with Verifiable Rewards}% 论文英文题目
\AUTHOR{Jiaxu Yan}% 论文作者
\ADVISOR{Supervisor: Professor Wei Li}% 指导教师
