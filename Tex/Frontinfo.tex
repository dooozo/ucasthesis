...
\title{面向大语言模型强化学习后训练的难度感知自适应采样策略研究}% 论文中文题目
\author{闫嘉序}% 论文作者
\advisor{李伟~研究员~中国科学院计算技术研究所\\}% 指导教师：姓名 专业技术职务 工作单位
...
%-> 英文封面信息
%-
\TITLE{Difficulty-Aware Adaptive Sampling Strategies for\\ Reinforcement Learning Post-Training of Large Language Models}% 论文英文题目
\AUTHOR{Jiaxu Yan}% 论文作者
\ADVISOR{Supervisor: Prof. Wei Li}% 指导教师
